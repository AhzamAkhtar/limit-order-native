...
fn process_instruction(
    ...
    match instruction {
        ...
        LimitOrderInstruction::CreateOrder(data) => {
            CreateOrder::create_order(program_id, accounts, data)
        }
        LimitOrderInstruction::TakeOrder(data) => TakeOrder::take_order(program_id, accounts, data),
        LimitOrderInstruction::CancelOrder(data) => {
            CancelOrder::cancel_order(program_id, accounts, data)
        }
    }
}
